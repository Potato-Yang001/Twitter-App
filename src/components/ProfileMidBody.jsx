...
export default function ProfileMidBody() {
    ...
    return (
        ...
        <Col sm={6} className="bg-light" style={{ border: "1px solid lightgrey" }}>
            ...
            <p className="mt-5" style={{ margin: 0, fontWeight: "bold", fontSize: "15px" }}>Carolina</p>
            <p style={{ marginBottom: "2px" }}>@bla.samingan</p>
            ...
            <p>
                <strong>271</strong> Following <strong>14.9K</strong> Followers
            </p>
